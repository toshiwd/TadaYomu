        ...
        {user ? (
            ...
            >
              ...
              <TouchableOpacity
                style={[
                  ...
                  {
                    backgroundColor: colors.surface,
                    borderColor: colors.ui.error || "#FF6B6B",
                    borderWidth: 1,
                    flex: 1,
                  },
                ]}
          ...
          >
            ...
            <TouchableOpacity
              style={[
                styles.actionBtn,
                { backgroundColor: colors.ui.primary, width: "100%" },
              ]}
          ...
          <SettingRow label="全画面モード (時計非表示)" colors={colors}>
            <View style={styles.toggleRow}>
              <TouchableOpacity
                style={[
                  styles.toggleBtn,
                  settings.fullscreen && { backgroundColor: colors.ui.primary },
                ]}
                onPress={() => updateSetting("fullscreen", true)}
              >
                <Text
                  style={{
                    color: settings.fullscreen ? "#FFF" : colors.text.primary,
                    fontSize: 12,
                    fontWeight: "600",
                  }}
                >
